...
#	print(i)
#	name_image="../sample-images-roc/{num:04d}.bmp".format(num=i)
#
#	mark_p = './ef26420c.npy'
#
#	mark = np.load(mark_p)
...
#	watermarked = embedding_ef26420c.embedding(name_image, './ef26420c.npy')
...
#	# start = time.time()
#	"""for i in range(100):
#	  dec, wpsnr = detection_ef26420c.detection(name_image, 'watermarked.bmp',
...
#	print('attack')
#	start = time.time()
#	dec, wpsnr = detection_ef26420c.detection(name_image, 'watermarked.bmp', 'attacked.bmp')
#	print('time consumed: ', time.time() - start)
#	print(dec)
#	print(wpsnr)
