...
def localised_attack(name_originalImage, name_watermarkedImage, awgn_std=21, blur_sigma=1.3, median_kernel_size=5, sharpening_sigma=0.5, sharpening_alpha=0.5, flat_sensor=0):
