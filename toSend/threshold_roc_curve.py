...
import embedding_ef26420c as em
import detection_ef26420c as dt
import attack as at
import psnr as ps
...
def compute_roc(mark_size, alpha, mark, dim, step,
	...
	for i in range(0,files_used):
		...
		watermarked = em.embedding(name_image="".join(['../sample-images-roc/', files[i]]),name_mark='ef26420c.npy',
								alpha=alpha,
